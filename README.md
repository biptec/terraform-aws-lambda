...
* [lambda](https://github.com/biptec/terraform-aws-lambda/blob/v0.2.2/modules/lambda): A module for deploying and managing Lambda functions.
* [lambda-edge](https://github.com/biptec/terraform-aws-lambda/blob/v0.2.2/modules/lambda-edge): A module for deploying and managing Lambda@Edge functions.
* [scheduled-lambda-job](https://github.com/biptec/terraform-aws-lambda/blob/v0.2.2/modules/scheduled-lambda-job): A module that configures AWS to run a Lambda function on a
  periodic basis.

Click on each module above to see its documentation. Head over to the [examples folder](https://github.com/biptec/terraform-aws-lambda/blob/v0.2.2/examples) for examples.
...
See the [test](https://github.com/biptec/terraform-aws-lambda/blob/v0.2.2/test) folder for details.
...
Please see [LICENSE.txt](https://github.com/biptec/terraform-aws-lambda/blob/v0.2.2/LICENSE.txt) for details on how the code in this repo is licensed.
