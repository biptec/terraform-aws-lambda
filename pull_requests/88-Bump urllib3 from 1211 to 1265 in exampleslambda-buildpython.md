# Bump urllib3 from 1.21.1 to 1.26.5 in /examples/lambda-build/python
...
<li>Additional commits viewable in <a href="https://github.com/urllib3/urllib3/compare/1.21.1...1.26.5">compare view</a></li>
</ul>
</details>
<br />


[![Dependabot compatibility score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=urllib3&package-manager=pip&previous-version=1.21.1&new-version=1.26.5)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
...
You can disable automated security fix PRs for this repo from the [Security Alerts page](https://github.com/gruntwork-io/terraform-aws-lambda/network/alerts).
