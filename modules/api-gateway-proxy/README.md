...
![Serverless architecture](https://github.com/biptec/terraform-aws-lambda/blob/v0.12.0/_docs/serverless-architecture.png?raw=true)
...
* [modules](https://github.com/biptec/terraform-aws-lambda/blob/v0.12.0/modules): the main implementation code for this repo, broken down into multiple standalone, orthogonal submodules.
* [examples](https://github.com/biptec/terraform-aws-lambda/blob/v0.12.0/examples): This folder contains working examples of how to use the submodules.
* [test](https://github.com/biptec/terraform-aws-lambda/blob/v0.12.0/test): Automated tests for the modules and examples.
...
* [examples folder](https://github.com/biptec/terraform-aws-lambda/blob/v0.12.0/examples): The `examples` folder contains sample code optimized for learning, experimenting, and testing (but not production usage).
