...
[lambda module](https://github.com/biptec/terraform-aws-lambda/blob/v0.5.1/modules/lambda)) on a scheduled basis. This is useful for periodic background jobs, such as taking a 
...
* See the [scheduled-lambda-job example](https://github.com/biptec/terraform-aws-lambda/blob/v0.5.1/examples/scheduled-lambda-job) folder for sample usage.
* See [vars.tf](./vars.tf) for all the variables you can set on this module.

The general idea is to:

1. Create a Lambda function using the [lambda module](https://github.com/biptec/terraform-aws-lambda/blob/v0.5.1/modules/lambda).
...
documentation](https://github.com/biptec/terraform-aws-lambda/blob/v0.5.1/modules/lambda). 