...
* See the [lambda-s3 example](https://github.com/biptec/terraform-aws-lambda/blob/v0.18.0/examples/lambda-s3) folder for sample usage.
...
Check out the [lambda-vpc example](https://github.com/biptec/terraform-aws-lambda/blob/v0.18.0/examples/lambda-vpc) for working sample code. Make sure to note the Known Issues
