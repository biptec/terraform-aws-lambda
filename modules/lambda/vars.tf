...
variable "mount_to_file_system" {
  description = "Set to true to mount your Lambda function on an EFS. Note that the lambda must also be deployed inside a VPC for this config to have any effect."
  type        = bool
  default     = false
}
