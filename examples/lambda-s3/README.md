...
See also the [lambda-build example](https://github.com/biptec/terraform-aws-lambda/blob/v0.11.1/examples/lambda-build) to see how you can execute build and packaging steps for
